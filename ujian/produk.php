<?php  
  ...
  if(isset($_POST['hapus'])){
    $script2 = "DELETE FROM ngethriftkuy where id = $id";
...
<body>
  ...
  <br>
  <ul><a href="barang.php" type="submit" class="btn btn-primary" >Kembali</a></ul>
    ...
    <div class="row">
      ...
      <div class="col-4">
        ...
        <div class="box-detail-produk">
          <h2>Aksi lainnya</h2>
          <form method="post">
            <a href="ubah.php?id=<?= $data['id']?>" class="btn btn-warning">Update produk</a>
