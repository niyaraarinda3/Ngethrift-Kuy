...
<body>
  ...
  <div class="wrapper">
    ...
    if($_GET['id'] == null){
      ...
      $id = $_GET['id'];
      $script = "SELECT * FROM ngethriftkuy where id = $id";
      ...
      if(isset($_POST['submit'])){
        if(isset($_FILES['foto'])){
          ...
          if($file_tmp == null){
            $foto = $data['foto'];
            $script = "UPDATE ngethriftkuy SET judul='$judul',harga=$harga,asal='$asal',deskripsi='$deskripsi',nama='$nama',telp='$telp',foto='$foto' where id=$id";
          }else{
    ...
    <form method="post" enctype="multipart/form-data">
      ...
      <div class="form-group">
        ...
        <input type="number" class="form-control" name="telp" value="0<?=$data['telp']?>">
      </div>
      <input type="submit" class="btn btn-primary " name="submit" value="Update">
      <a href="produk.php" type="submit" class="btn btn-primary" >Cancel</a>
    </form>
